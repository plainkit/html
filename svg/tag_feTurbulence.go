...
func FeTurbulence(attrs FeTurbulenceAttrs, children ...html.Component) html.Node {
	return html.Node{Tag: "feTurbulence", Attrs: &attrs, Kids: children}
}
...
func (a *FeTurbulenceAttrs) writeAttrs(sb *strings.Builder) {
	...
	if a.BaseFrequency != "" {
		html.Attr(sb, "baseFrequency", a.BaseFrequency)
	}
	if a.BaselineShift != "" {
	...
	if a.NumOctaves != "" {
		html.Attr(sb, "numOctaves", a.NumOctaves)
	}
	if a.Opacity != "" {
	...
	if a.Seed != "" {
		html.Attr(sb, "seed", a.Seed)
	}
	if a.ShapeRendering != "" {
		html.Attr(sb, "shape-rendering", a.ShapeRendering)
	}
	if a.StitchTiles != "" {
		html.Attr(sb, "stitchTiles", a.StitchTiles)
	}
	if a.StopColor != "" {
