...
func (g Global) applyH2(a *H2Attrs, _ *[]Component)      { g.do(&a.Global) }
...
func (a *H2Attrs) writeAttrs(sb *strings.Builder)        { writeGlobal(sb, &a.Global) }
