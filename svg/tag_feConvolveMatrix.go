...
func (a *FeConvolveMatrixAttrs) writeAttrs(sb *strings.Builder) {
	...
	if a.Divisor != "" {
		html.Attr(sb, "divisor", a.Divisor)
	}
	if a.DominantBaseline != "" {
		html.Attr(sb, "dominant-baseline", a.DominantBaseline)
	}
	if a.EdgeMode != "" {
		html.Attr(sb, "edgeMode", a.EdgeMode)
	}
	...
	if a.KernelMatrix != "" {
		html.Attr(sb, "kernelMatrix", a.KernelMatrix)
	}
	if a.KernelUnitLength != "" {
		html.Attr(sb, "kernelUnitLength", a.KernelUnitLength)
	}
	if a.Kerning != "" {
	...
	if a.PreserveAlpha != "" {
		html.Attr(sb, "preserveAlpha", a.PreserveAlpha)
	}
	if a.Result != "" {
	...
	if a.TargetX != "" {
		html.Attr(sb, "targetX", a.TargetX)
	}
	if a.TargetY != "" {
		html.Attr(sb, "targetY", a.TargetY)
	}
	if a.TextAnchor != "" {
