...
func Glyph(attrs GlyphAttrs, children ...html.Component) html.Node {
	return html.Node{Tag: "glyph", Attrs: &attrs, Kids: children}
}
...
func (a *GlyphAttrs) writeAttrs(sb *strings.Builder) {
	...
	if a.ArabicForm != "" {
		html.Attr(sb, "arabic-form", a.ArabicForm)
	}
	if a.BaselineShift != "" {
	...
	if a.GlyphName != "" {
		html.Attr(sb, "glyph-name", a.GlyphName)
	}
	...
	if a.HorizAdvX != "" {
		html.Attr(sb, "horiz-adv-x", a.HorizAdvX)
	}
	if a.ImageRendering != "" {
	...
	if a.Orientation != "" {
		html.Attr(sb, "orientation", a.Orientation)
	}
	if a.Overflow != "" {
	...
	if a.Unicode != "" {
		html.Attr(sb, "unicode", a.Unicode)
	}
	if a.UnicodeBidi != "" {
		html.Attr(sb, "unicode-bidi", a.UnicodeBidi)
	}
	if a.VertAdvY != "" {
		html.Attr(sb, "vert-adv-y", a.VertAdvY)
	}
	if a.VertOriginX != "" {
		html.Attr(sb, "vert-origin-x", a.VertOriginX)
	}
	if a.VertOriginY != "" {
		html.Attr(sb, "vert-origin-y", a.VertOriginY)
	}
	if a.Visibility != "" {
