...
func Filter(attrs FilterAttrs, children ...html.Component) html.Node {
	return html.Node{Tag: "filter", Attrs: &attrs, Kids: children}
}
...
func (a *FilterAttrs) writeAttrs(sb *strings.Builder) {
	...
	if a.FilterRes != "" {
		html.Attr(sb, "filterRes", a.FilterRes)
	}
	if a.FilterUnits != "" {
		html.Attr(sb, "filterUnits", a.FilterUnits)
	}
	if a.FloodColor != "" {
	...
	if a.PrimitiveUnits != "" {
		html.Attr(sb, "primitiveUnits", a.PrimitiveUnits)
	}
	if a.ShapeRendering != "" {
