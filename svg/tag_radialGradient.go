...
func (a *RadialGradientAttrs) writeAttrs(sb *strings.Builder) {
	...
	if a.Cx != "" {
		html.Attr(sb, "cx", a.Cx)
	}
	if a.Cy != "" {
		html.Attr(sb, "cy", a.Cy)
	}
	if a.Direction != "" {
	...
	if a.Fr != "" {
		html.Attr(sb, "fr", a.Fr)
	}
	if a.Fx != "" {
		html.Attr(sb, "fx", a.Fx)
	}
	if a.Fy != "" {
		html.Attr(sb, "fy", a.Fy)
	}
	...
	if a.GradientTransform != "" {
		html.Attr(sb, "gradientTransform", a.GradientTransform)
	}
	if a.GradientUnits != "" {
		html.Attr(sb, "gradientUnits", a.GradientUnits)
	}
	if a.Href != "" {
	...
	if a.SpreadMethod != "" {
		html.Attr(sb, "spreadMethod", a.SpreadMethod)
	}
	if a.StopColor != "" {
