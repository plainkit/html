...
func (a *MarkerAttrs) writeAttrs(sb *strings.Builder) {
	...
	if a.MarkerHeight != "" {
		html.Attr(sb, "markerHeight", a.MarkerHeight)
	}
	if a.MarkerMid != "" {
	...
	if a.MarkerUnits != "" {
		html.Attr(sb, "markerUnits", a.MarkerUnits)
	}
	if a.MarkerWidth != "" {
		html.Attr(sb, "markerWidth", a.MarkerWidth)
	}
	if a.Mask != "" {
	...
	if a.RefX != "" {
		html.Attr(sb, "refX", a.RefX)
	}
	if a.RefY != "" {
		html.Attr(sb, "refY", a.RefY)
	}
	if a.ShapeRendering != "" {
