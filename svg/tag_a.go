...
func A(attrs AAttrs, children ...html.Component) html.Node {
	return html.Node{Tag: "a", Attrs: &attrs, Kids: children}
}
...
func (a *AAttrs) writeAttrs(sb *strings.Builder) {
	...
	if a.Download != "" {
		html.Attr(sb, "download", a.Download)
	}
	...
	if a.Hreflang != "" {
		html.Attr(sb, "hreflang", a.Hreflang)
	}
	if a.ImageRendering != "" {
	...
	if a.Ping != "" {
		html.Attr(sb, "ping", a.Ping)
	}
	if a.PointerEvents != "" {
		html.Attr(sb, "pointer-events", a.PointerEvents)
	}
	if a.Referrerpolicy != "" {
		html.Attr(sb, "referrerpolicy", a.Referrerpolicy)
	}
